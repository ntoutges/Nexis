...
widget1.addons.get("main").sender.on("connect", (data) => { console.log(data, "connect"); });
widget1.addons.get("main").sender.on("receive", (data) => { console.log(data); });
widget1.addons.get("main").sender.on("disconnect", (data) => { console.log(data, "disconencted"); });
