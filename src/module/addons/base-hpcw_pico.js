...
export class Addon extends Saveable {
    ...
    attachTo(addonEdge, id) {
        ...
        if (this.addonEdge) { // add new listeners
            ...
            this.openId = widget.elListener.on("attach", this.listener.trigger.bind(this.listener, "open"));
            this.closeId = widget.elListener.on("detach", this.listener.trigger.bind(this.listener, "close"));
            this.dragEndId = widget.elListener.on("dragend", this.listener.trigger.bind(this.listener, "dragend"));
            this.dragInitId = widget.elListener.on("draginit", this.listener.trigger.bind(this.listener, "draginit"));
