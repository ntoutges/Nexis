...
import { ContextMenuEvents, ContextMenuItemInterface, FrameworkBaseInterface, resizeType } from "./interfaces.js";
import { Listener } from "./listener.js";
import { Scene } from "./scene.js";
import { ContextMenuItem, ContextMenuSection } from "./widgets/contextmenu/items.js";
import { BasicWidgetInterface, ContextMenuInterface, GlobalSingleUseWidgetInterface, SceneListenerTypes, sceneListener } from "./widgets/interfaces.js";
...
export class FrameworkBase {
  ...
  constructor({
    ...
    setTimeout(() => { // take advantage of event system; only build after
